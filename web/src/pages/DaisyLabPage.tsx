    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-2">
        <div>
          ...
          <p className="text-sm text-base-content/70">Visual sweep for major DaisyUI components.</p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <label className="label cursor-pointer gap-2">
              ...
              <input type="radio" name="radio-demo" className="radio radio-accent" defaultChecked />
            </label>
          </div>
      ...
      <Section title="Cards & Collapse">
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="collapse collapse-arrow border border-base-300 bg-base-100">
            ...
            <div className="collapse-title text-md font-medium">Collapse example</div>
