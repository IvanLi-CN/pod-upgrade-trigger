				...
				<div className="card bg-base-100 shadow-sm">
					<div className="card-body gap-3">
						...
						<ul className="space-y-1 text-xs text-base-content/80">
							<li>
								Interval: <code>{scheduler?.interval_secs ?? "--"}</code>{" "}
								seconds
							</li>
							<li>
								Min interval:{" "}
							...
							<div className="space-y-1">
								{(systemd?.trigger_units ?? []).map((unit) => (
									...
									>
										...
										<Link to="/services" className="btn btn-ghost btn-xs gap-1">
											<Icon
			...
			<section className="grid gap-4 md:grid-cols-2">
				<div className="card bg-base-100 shadow-sm">
					<div className="card-body gap-3">
						...
						<ul className="space-y-1 text-xs text-base-content/80">
							...
							<li>
								Package version:{" "}
								<code>{settings?.version.package ?? "--"}</code>
							</li>
							<li>
								Build time:{" "}
				...
				<div className="card bg-base-100 shadow-sm">
					<div className="card-body gap-3">
						...
						<ul className="space-y-1 text-xs text-base-content/80">
							<li>
								Header: <code>{forward?.header ?? "(not configured)"}</code>
							</li>
							<li>
	...
	return (
		<tr>
			...
			<td className="text-xs">
				{secret ? (isConfigured ? "***" : "(empty)") : (value ?? "(empty)")}
			</td>
		</tr>
	);
}
